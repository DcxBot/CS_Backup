...
import {
  ...
  exportToCSV,
} from "../../mockData/peachDashboardData";
import "../../styles/PeachDashboard.css";

const PeachDashboard = () => {
  // State management
  ...
  // Initialize data
  useEffect(() => {
    setTransactions(peachDashboardData.transactions);
    setFilteredTransactions(peachDashboardData.transactions);
  }, []);
  ...
  return (
    <div className="dashboard-container peach-dashboard">
      ...
      <div className="dashboard-header">
        <h1 className="main-title">
          Peach <span className="title-emphasis">Dashboard</span>
        </h1>
        <p className="subtitle">
          Detailed reconciliation view for{" "}
          <span className="subtitle-emphasis">Peach</span> transactions
        </p>
      </div>
      ...
      <div className="summary-grid">
        <SummaryCard
          ...
          value={peachDashboardData.summary.totalTransactions.toLocaleString()}
          icon="DollarSign"
          iconColor="#2D6A5A"
          valueColor="#2D6A5A"
        ...
        <SummaryCard
          ...
          title="% Matched"
          value={`${peachDashboardData.summary.matchedPercentage}%`}
          icon="CheckCircle"
          iconColor="#16A34A"
          valueColor="#15803D"
        ...
        <SummaryCard
          id="unmatched"
          title="Unmatched"
          value={peachDashboardData.summary.unmatched.toLocaleString()}
          icon="AlertTriangle"
          iconColor="#DC2626"
          valueColor="#B91C1C"
        ...
        <SummaryCard
          id="exceptions"
          title="Exceptions"
          value={peachDashboardData.summary.exceptions.toLocaleString()}
          icon="TrendingUp"
          iconColor="#EA580C"
          valueColor="#C2410C"
      ...
      <FilterPanel
        filters={filters}
        filterOptions={peachDashboardData.filterOptions}
