...
import {
  ...
  exportToCSV,
} from "../../mockData/crossSwitchDashboardData";
import "../../styles/CrossSwitchDashboard.css";

const CrossSwitchDashboard = () => {
  // State management
  ...
  // Initialize data
  useEffect(() => {
    setTransactions(crossSwitchDashboardData.transactions);
    setFilteredTransactions(crossSwitchDashboardData.transactions);
  }, []);
  ...
  return (
    <div className="dashboard-container crossswitch-dashboard">
      ...
      <div className="dashboard-header">
        <h1 className="main-title">
          CrossSwitch <span className="title-emphasis">Dashboard</span>
        </h1>
        <p className="subtitle">
          Detailed reconciliation view for{" "}
          <span className="subtitle-emphasis">CrossSwitch</span> transactions
        </p>
      </div>
      ...
      <div className="summary-grid">
        <SummaryCard
          ...
          value={crossSwitchDashboardData.summary.totalTransactions.toLocaleString()}
          icon="DollarSign"
          iconColor="#2D6A5A"
          valueColor="#2D6A5A"
        ...
        <SummaryCard
          ...
          title="% Matched"
          value={`${crossSwitchDashboardData.summary.matchedPercentage}%`}
          icon="CheckCircle"
          iconColor="#16A34A"
          valueColor="#15803D"
        ...
        <SummaryCard
          id="unmatched"
          title="Unmatched"
          value={crossSwitchDashboardData.summary.unmatched.toLocaleString()}
          icon="AlertTriangle"
          iconColor="#DC2626"
          valueColor="#B91C1C"
        ...
        <SummaryCard
          id="exceptions"
          title="Exceptions"
          value={crossSwitchDashboardData.summary.exceptions.toLocaleString()}
          icon="TrendingUp"
          iconColor="#EA580C"
          valueColor="#C2410C"
      ...
      <FilterPanel
        filters={filters}
        filterOptions={crossSwitchDashboardData.filterOptions}
...
export default CrossSwitchDashboard;
