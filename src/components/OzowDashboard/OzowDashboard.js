...
import {
  ...
  exportToCSV,
} from "../../mockData/ozowDashboardData";
import "../../styles/OzowDashboard.css";
...
const OzowDashboard = () => {
  ...
  // Initialize data
  useEffect(() => {
    setTransactions(ozowDashboardData.transactions);
    setFilteredTransactions(ozowDashboardData.transactions);
  }, []);
  ...
  return (
    <div className="dashboard-container ozow-dashboard">
      ...
      <div className="dashboard-header">
        <h1 className="main-title">
          Ozow <span className="title-emphasis">Dashboard</span>
        </h1>
        <p className="subtitle">
          Detailed reconciliation view for{" "}
          <span className="subtitle-emphasis">Ozow</span> transactions
        </p>
      </div>
      ...
      <div className="summary-grid">
        <SummaryCard
          ...
          value={ozowDashboardData.summary.totalTransactions.toLocaleString()}
          icon="DollarSign"
          iconColor="#2D6A5A"
          valueColor="#2D6A5A"
        ...
        <SummaryCard
          ...
          title="% Matched"
          value={`${ozowDashboardData.summary.matchedPercentage}%`}
          icon="CheckCircle"
          iconColor="#16A34A"
          valueColor="#15803D"
        ...
        <SummaryCard
          id="unmatched"
          title="Unmatched"
          value={ozowDashboardData.summary.unmatched.toLocaleString()}
          icon="AlertTriangle"
          iconColor="#DC2626"
          valueColor="#B91C1C"
        ...
        <SummaryCard
          id="exceptions"
          title="Exceptions"
          value={ozowDashboardData.summary.exceptions.toLocaleString()}
          icon="TrendingUp"
          iconColor="#EA580C"
          valueColor="#C2410C"
      ...
      <FilterPanel
        filters={filters}
        filterOptions={ozowDashboardData.filterOptions}
